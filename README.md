...
* **Nhịp tim hệ thống (Heartbeat):** Liên tục giám sát kết nối bằng MSG\_PEEK. Ngắt kết nối chuẩn mực (Graceful Disconnect) khi phát hiện sự cố, chống Crash ứng dụng.
